...
<script>
	$(document).ready(function(){
		...
		$('.edit_data').click(function(){
			uni_modal("Edit Department","departments/manage_department.php?id="+$(this).attr('data-id'));
		})
		$('.view_data').click(function(){
			uni_modal("View Department","departments/view_department.php?id="+$(this).attr('data-id'));
		})
