		...
		<div class="container-fluid">
			<table class="table table-bordered table-stripped">
				...
				<tbody>
					<?php 
					$i = 1;
						$qry = $conn->query("SELECT * from `position_list` where delete_flag = 0 order by `name` asc ");
...
<script>
	$(document).ready(function(){
		$('#create_new').click(function(){
			uni_modal("Add New Position","positions/manage_position.php");
		})
		$('.edit_data').click(function(){
			uni_modal("Edit Position","positions/manage_position.php?id="+$(this).attr('data-id'));
		})
		$('.view_data').click(function(){
			uni_modal("View position","positions/view_position.php?id="+$(this).attr('data-id'));
		})
